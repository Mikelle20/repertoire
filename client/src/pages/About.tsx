            ...
            <p className="aboutParagraph">
              ...
              <Tooltip title={(
                <div className="toolTip">
                  <div>Email: mikellewade@gmail.com</div>
                  <div>
                    My Spotify:
                    <a className="link" href="https://open.spotify.com/user/mikellewade?si=c6dc1f6dd2f64a73">elle 🍄🍒</a>
                  </div>
                </div>
)}
              >
                <span id="myname">Mikelle</span>
              </Tooltip>
              {' '}
