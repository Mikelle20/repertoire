...
// }
var getStatus = function (searcher, arr) { return __awaiter(_this, void 0, void 0, function () {
    var statuses_1, _loop_1, i, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _loop_1 = function (i) {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, db.Friend.findOne({
                                    where: (_b = {},
                                        _b[Op.or] = [
                                            {
                                                user_1: searcher,
                                    ...
                                    if (res) {
                                        statuses_1.push(__assign({}, res.dataValues));
                                    }
                                    else {
                                        statuses_1.push({
                                            user_1: arr[i].user_id,
            ...
            case 3:
                i++;
                return [3 /*break*/, 1];
            case 4: return [2 /*return*/, statuses_1];
            case 5:
                error_1 = _a.sent();
