...
var setPlaylists = function (playlists, headers) { return __awaiter(void 0, void 0, void 0, function () {
    var arr, _loop_1, _i, playlists_1, element;
            ...
            case 0:
                ...
                _loop_1 = function (element) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                url = "https://api.spotify.com/v1/playlists/".concat(element.dataValues.playlist_id);
                ...
                _a.label = 1;
            case 1:
                if (!(_i < playlists_1.length)) return [3 /*break*/, 4];
...
module.exports = { setPlaylists: setPlaylists };
